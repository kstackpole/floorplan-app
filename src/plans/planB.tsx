        ...
        >
            ...
            487,325.9 487,17.7 455,17.7 455,13.1 491.5,13.1 491.5,143.2 	"/>
                ...
                <g id="gourmetKitchen" data-option="gourmetKitchen" style={{ display: active.gourmetKitchen ? "block" : "none" }}>
                    <rect x={500} y={510} width={280} height={170} fill="#dcdcdc" stroke="#dcdcdc" strokeWidth={10} filter="url(#glow)" /><polyline fill="none" stroke="#666666" stroke-miterlimit="10" points="491.9,635.2 700.3,635.2 700.3,663.9 	"/>
